                                                ...
                                                script
                                                        {
                                                            ...
                                                            if (env.BUILD_DOCKER == "true") {
                                                                sh 'service docker start && docker buildx build --platform linux/arm64,linux/arm/v7 --push -t sebpiller/jenkins-server:latest -t sebpiller/jenkins-server:${DOCKER_TAG} .'
                                                            } else {
